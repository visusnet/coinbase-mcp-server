---
name: trading-report
description: "Phase 4: Output structured trading cycle report with rankings, spotlight, rationale, and session stats."
---

# Trading Report (Phase 4)

**Sub-skill of `coinbase-trading`.** Called via `Skill("trading-report")` each trading cycle.

This skill outputs a structured report summarizing the current cycle's analysis, decisions, and actions.

## Scope

15. Output structured cycle report

**Output**: Formatted report displayed to the user.
...
**Padding procedure**:
1. Write the content
2. Count: spaces + emoji widths + character count
