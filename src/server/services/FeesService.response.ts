...
export const GetTransactionsSummaryResponseSchema = z
  .object({
    ...
    feeTier: FeeTierSchema.describe('Current fee tier information'),
    marginRate: TypesDecimalSchema.optional().describe('Margin rate'),
    goodsAndServicesTax:
      GoodsAndServicesTaxSchema.optional().describe('GST information'),
