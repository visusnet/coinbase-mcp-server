...
export const ListPortfoliosResponseSchema = z
  .object({
    portfolios: z.array(SpotPortfolioSchema).describe('List of portfolios'),
  })
  .describe('Response for listing portfolios');

export const CreatePortfolioResponseSchema = z
  .object({
    portfolio: SpotPortfolioSchema.optional().describe('Created portfolio'),
  })
  .describe('Response for creating a portfolio');

export const GetPortfolioResponseSchema = PortfolioBreakdownSchema.describe(
  'Response for getting a portfolio',
);

export const EditPortfolioResponseSchema = z
  .object({
    portfolio: SpotPortfolioSchema.optional().describe('Edited portfolio'),
  })
