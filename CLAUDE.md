...
MCP server with 67 tools (46 Coinbase Advanced Trade API + 21 technical indicators).
...
npm run inspect    # MCP Inspector at http://localhost:6274
                   ...
                   # Click "List Tools" to see all 67 tools
```
...
- [docs/IMPLEMENTED_TOOLS.md](docs/IMPLEMENTED_TOOLS.md) - All 67 tools
